...
const OrderMeta = props => {
  const { user, order, address, phoneNumber, payment, cancelOrder, onBack } = props;
  ...
  return (
    <div className='order-meta'>
      ...
      <Row>
        ...
        <Row>
            <Col xs='4'>
              <p className='one-line-ellipsis'>Order Name</p>
            </Col>
            <Col xs='8'>
              <span className='order-label one-line-ellipsis'>{`${order.name}`}</span>
            </Col>
          </Row>
          <Row>
            <Col xs='4'>
          ...
          <Row>
            <Col xs='4'>
              <p className='one-line-ellipsis'>Contact Number</p>
            </Col>
            <Col xs='8'>
          ...
          <Row>
            <Col xs='4'>
              <p className='one-line-ellipsis'>Delivery Location</p>
            </Col>
            <Col xs='8'>
              <span className='order-label '>{` ${order.address.address} ${order.address.city} ${order.address.state}`}</span>
            </Col>
          </Row>
          <Row>
            <Col xs='4'>
            ...
            <Col xs='8'>
              <span className='order-label one-line-ellipsis'>{`${payment} `}</span>
            </Col>
          </Row>
          <Row></Row>
        </Col>
