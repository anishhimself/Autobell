  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h2>Become An AutobellGears Seller!</h2>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your products on AutobellGears Store!</h3>
                  <h4>Grow your business with AutobellGears Store</h4>
                  <b>This Section might not work as it is under maintenance.</b>
                </div>
              </Col>
